const i18n = {
  pt: {
    ...
    "flow.yes": "Sim",
    "flow.no": "Não",
    "flow.exceptionQuestion": "Ocorreu exceção?",
    "flow.propagates": "propaga o erro",
    "flow.omitted": "... +{count} instruções",
    "flow.truncated":
      "Fluxograma resumido: limite de {max} blocos; {count} instruções não desenhadas.",
    "flow.unavailable": "Não foi possível gerar o fluxograma deste código.",
    "flow.follow": "Seguir execução",
    "flow.followHint": "Seguir execução: voltar a acompanhar a função em execução",
    "flow.runningIn": "Em execução agora: {name}",
    "flow.depth": "nível de chamada {n}",
    "flow.aria": "Fluxograma de {name}, {count} blocos.",
    "flow.ariaNext": "Próximo bloco: {text}.",
    "flow.ariaExecuted": "Último bloco executado: {text}.",
    "flow.tip.process": "Instrução",
    "flow.tip.input": "Entrada de dados (input)",
    "flow.tip.output": "Saída de dados (print)",
    "flow.tip.decision": "Decisão (if/elif)",
    "flow.tip.loop": "Repetição (for/while)",
    "flow.tip.return": "Retorna da função",
    "flow.tip.break": "Sai do laço",
    "flow.tip.continue": "Volta ao início do laço",
    "flow.tip.raise": "Levanta uma exceção",
    "flow.tip.definition": "Definição (clique para ver o fluxograma)",
    "flow.tip.omitted": "Instruções omitidas (limite de blocos)",
    "flow.legend.terminal": "Início / fim",
    "flow.legend.process": "Instrução",
    "flow.legend.decision": "Decisão / laço",
    "flow.legend.io": "Entrada / saída",
  ...
  en: {
    ...
    "flow.yes": "Yes",
    "flow.no": "No",
    "flow.exceptionQuestion": "Exception raised?",
    "flow.propagates": "propagates the error",
    "flow.omitted": "... +{count} statements",
    "flow.truncated":
      "Summarized flowchart: limit of {max} blocks; {count} statements not drawn.",
    "flow.unavailable": "The flowchart for this code could not be generated.",
    "flow.follow": "Follow execution",
    "flow.followHint": "Follow execution: go back to tracking the running function",
    "flow.runningIn": "Running now: {name}",
    "flow.depth": "call level {n}",
    "flow.aria": "Flowchart of {name}, {count} blocks.",
    "flow.ariaNext": "Next block: {text}.",
    "flow.ariaExecuted": "Last executed block: {text}.",
    "flow.tip.process": "Statement",
    "flow.tip.input": "Data input (input)",
    "flow.tip.output": "Data output (print)",
    "flow.tip.decision": "Decision (if/elif)",
    "flow.tip.loop": "Loop (for/while)",
    "flow.tip.return": "Returns from the function",
    "flow.tip.break": "Leaves the loop",
    "flow.tip.continue": "Jumps back to the start of the loop",
    "flow.tip.raise": "Raises an exception",
    "flow.tip.definition": "Definition (click to see its flowchart)",
    "flow.tip.omitted": "Omitted statements (block limit)",
    "flow.legend.terminal": "Start / end",
    "flow.legend.process": "Statement",
    "flow.legend.decision": "Decision / loop",
    "flow.legend.io": "Input / output",
